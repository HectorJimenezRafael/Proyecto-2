...
function Eliminar(id) {
    Swal.fire({
        title: '¿Quiere eliminar a este personal de mantenimiento?',
        icon: 'warning',
            ...
            ajax.onload = function() {
                if (ajax.status === 200) {
                    ...
                    if (ajax.responseText == "ok") {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Personal de mantenimiento despedido correctamente',
...
registrar.addEventListener("click", () => {
    ...
    var ajax = new XMLHttpRequest();
    ajax.open('POST', '../cruds/crear_mantenimiento.php');
    ajax.onload = function() {
        if (ajax.status === 200) {
            ...
            if (ajax.responseText == "ok") {
                Swal.fire({
                    icon: 'success',
                    title: 'Personal de mantenimiento creado correctamente',
                    background: '#006d6d',
                    color: 'white',
                    showConfirmButton: false,
                    timerProgressBar: true,
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Personal de mantenimiento modificado correctamente',
                    showConfirmButton: false,
                    background: '#006d6d',
                    color: 'white',
                    timerProgressBar: true,
