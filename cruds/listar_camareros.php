...
if(!empty($_POST['buscar_nombre'])  ){
    ...
    $consulta = $pdo->prepare("SELECT * FROM tbl_usuarios WHERE usuario_tipo=1 AND usuario_nombre LIKE '%".$flitro_nombre."%' AND Apellido LIKE '%".$flitro_apellido."%'  AND correo LIKE '%".$flitro_correo."%' AND telefono LIKE '".$flitro_telefono."%' ");
