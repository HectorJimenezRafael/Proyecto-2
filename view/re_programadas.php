            ...
            <div class="col-lg-4">
                <div class="card" style="border-radius: 30px;">
                    <div class="card-header  titulo2" style="background-color: #8eb9d6;border-radius: 30px 30px 0px 0px;">
                        <h3  class="text-center">Reservas programadas <i class="fa-solid fa-file"></i></h3>
                    </div>
                        ...
                        <form action="" method="post" id="busqueda">
                            <div class="form-group2">
                              ...
                              <input style="display: none;"  type="text" name="buscar_correo" id="buscar_correo" placeholder="Correo..." class="form-control">
                                ...
                                <input style="display: none;"  type="date" name="buscar_dia" id="buscar_dia" placeholder="Apellido..." class="form-control">
                                
                                <input style="display: none;"  type="time" name="buscar_hora" id="buscar_hora" placeholder="" class="form-control">
